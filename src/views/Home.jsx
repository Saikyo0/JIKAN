      ...
      <div className="container" style={{ height: "1900px" }}>
        ...
        <main className="main">
          ...
          <div className="brands">
            <img src="../src/assets/brands/casio.png" alt="G-SHOCK Watch" />
            <img src="../src/assets/brands/orient2.png" style={{ width: "290px", height: "auto", maxHeight: "none" }} alt="G-SHOCK Watch" />
            <img src="../src/assets/brands/citizen.png" alt="G-SHOCK Watch" />
            <img src="../src/assets/brands/seiko.png" alt="G-SHOCK Watch" />
          </div>
          ...
          <div className="contact">
            <div className="contactAbout">
              <div className="transfer">
                <img src="../src/assets/transfer/visa.svg" className='ticon' />
                <img src="../src/assets/transfer/ae.png" className='ticon' />
                <img src="../src/assets/transfer/om.png" className='ticon' />
                <img src="../src/assets/transfer/pp.png" className='ticon' />
                <img src="../src/assets/transfer/disc.svg" className='ticon' />
                <img src="../src/assets/transfer/mc.png" className='ticon' />
              </div>
